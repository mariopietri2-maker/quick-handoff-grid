...
export function nextOpeningLabel(openingHours: OpeningHours, now: Date = new Date()): string | null {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    const day = (openingHours as Record<string, DayHours | undefined>)[key as string];
