...
export function useStoreOrders(
      ...
      .on(
        ...
        (payload) => {
          if (payload.eventType === 'INSERT') {
            ...
            try {
              startOrderAlertLoop({ maxRepeats: (typeof autoAcceptRef !== 'undefined' && autoAcceptRef.current) ? 5 : null });
  ...
  useEffect(() => {
    ...
    if (hasNew) startOrderAlertLoop({ maxRepeats: (typeof autoAcceptRef !== 'undefined' && autoAcceptRef.current) ? 5 : null });
