...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      <SEO
title="Fresh2GO — Φρέσκο Φαγητό. Γρήγορη Παράδοση."
        description="Γρήγορη Παράδοση. Η πλατφόρμα delivery που συνδέει πελάτες, εστιατόρια και οδηγούς σε πραγματικό χρόνο. Γρήγορα, αξιόπιστα, στην πόρτα σας."
        path="/"
      />
