    ...
    <div className="min-h-screen bg-[hsl(220,20%,7%)] text-[hsl(220,14%,96%)]">
      ...
      <nav className="sticky top-0 z-50 border-b border-[hsl(220,20%,14%)] bg-[hsl(220,20%,7%)]/90 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <Button
            size="sm"
            className="gradient-primary text-primary-foreground font-heading font-bold rounded-lg"
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 pt-24 pb-20 text-center">
          ...
          <p className="text-[hsl(220,10%,55%)] text-lg max-w-lg mx-auto mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-16">
            <Button
              size="lg"
              className="h-14 px-8 text-base font-heading font-bold gradient-primary shadow-primary text-primary-foreground rounded-xl"
            ...
            <Button
              size="lg"
              variant="outline"
              className="h-14 px-8 text-base font-heading font-semibold border-[hsl(220,20%,18%)] text-[hsl(220,14%,96%)] hover:bg-[hsl(220,20%,12%)] bg-transparent rounded-xl"
      ...
      <section className="max-w-6xl mx-auto px-4 py-20">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <FeatureCard icon={Zap} title="Ενημερώσεις σε Πραγματικό Χρόνο" description="Συγχρονισμός παραγγελιών μέσω WebSocket μεταξύ οδηγών και καταστημάτων." />
          <FeatureCard icon={Shield} title="Ασφαλές & Αξιόπιστο" description="Ασφάλεια σε επίπεδο γραμμής, πιστοποίηση και επίλυση συγκρούσεων." />
          <FeatureCard icon={BarChart3} title="Αναλυτικά" description="Παρακολούθηση κερδών, βελτιστοποίηση χρόνου προετοιμασίας και μετρήσεις απόδοσης." />
          <FeatureCard icon={MapPin} title="Έξυπνη Δρομολόγηση" description="Αλγόριθμοι AI για τη βέλτιστη ανάθεση παραγγελιών στους πλησιέστερους οδηγούς." />
          <FeatureCard icon={Clock} title="Γρήγορη Παράδοση" description="Μέσος χρόνος παράδοσης κάτω από 30 λεπτά σε όλη την πόλη." />
          <FeatureCard icon={Users} title="Υποστήριξη 24/7" description="Ζωντανή υποστήριξη για οδηγούς, καταστήματα και πελάτες όλο το εικοσιτετράωρο." />
        </div>
      </section>
      ...
      <section className="mx-4 mb-12">
        <div className="max-w-4xl mx-auto rounded-3xl gradient-primary p-12 text-center">
          ...
          <Button
            size="lg"
            className="h-14 px-8 text-base font-heading font-bold bg-primary-foreground text-primary hover:bg-primary-foreground/90 rounded-xl"
            onClick={() => navigate('/auth')}
          >
            Εγγραφή Δωρεάν
            <ArrowRight className="ml-2 h-5 w-5" />
...
function FeatureCard({ icon: Icon, title, description }: { icon: React.ElementType; title: string; description: string }) {
  return (
    <div className="rounded-2xl border border-[hsl(220,20%,14%)] bg-[hsl(220,20%,10%)] p-6 hover:border-primary/30 transition-colors">
