  ...
  refunds: {
    ...
    el: {
      ...
      sections: [
        ...
        { h: "4. Χρονικά Πλαίσια", p: "Απάντηση εντός 24 ωρών. Εγκεκριμένες επιστροφές πιστώνονται στο πορτοφόλι Fresh Meal άμεσα. Επιστροφή στην κάρτα μέσω Stripe γίνεται μόνο χειροκίνητα από την υποστήριξη όταν απαιτείται (5–10 εργάσιμες)." },
    ...
    en: {
      ...
      sections: [
        ...
        { h: "4. Timing", p: "Response within 24 hours. Approved refunds are credited instantly to your Fresh Meal wallet. Original-card Stripe refunds are issued only manually by support when required (5–10 business days)." },
