  ...
  if (analytics.loading) {
    return (
      <div className="text-center py-16">
        ...
        <p className="text-muted-foreground font-heading">Loading analytics...</p>
      </div>
    );
  }
    ...
    <div className="space-y-4">
        ...
        <Card className="shadow-[var(--shadow-md)]">
          <CardContent className="p-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs text-muted-foreground font-heading">Today</span>
            </div>
        ...
        <Card className="shadow-[var(--shadow-md)]">
          <CardContent className="p-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs text-muted-foreground font-heading">This Week</span>
            </div>
            <p className="font-heading font-bold text-2xl text-foreground">${analytics.weekRevenue.toFixed(2)}</p>
            <p className="text-xs text-muted-foreground">{analytics.weekOrders} orders</p>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-[var(--shadow-md)]">
          <CardContent className="p-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs text-muted-foreground font-heading">Avg Prep</span>
            </div>
            <p className="font-heading font-bold text-2xl text-foreground">
              {analytics.avgPrepTime > 0 ? `${analytics.avgPrepTime} min` : '—'}
            </p>
        ...
        <Card className="shadow-[var(--shadow-md)]">
          <CardContent className="p-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs text-muted-foreground font-heading">30 Days</span>
            </div>
      ...
      <Card className="shadow-[var(--shadow-md)]">
        <CardHeader className="pb-2">
          <CardTitle className="font-heading text-lg">Daily Revenue (7 days)</CardTitle>
        </CardHeader>
        <CardContent>
          {analytics.weekOrders === 0 ? (
            <p className="text-center text-sm text-muted-foreground py-8">No orders this week yet</p>
          ) : (
            <div className="h-48">
      ...
      <Card className="shadow-[var(--shadow-md)]">
        ...
        <CardContent>
          {analytics.popularItems.length === 0 ? (
            <p className="text-center text-sm text-muted-foreground py-4">No order data yet</p>
          ) : (
      ...
      <Card className="shadow-[var(--shadow-md)]">
        <CardHeader className="pb-2">
          <CardTitle className="font-heading text-lg">Order Status (30 days)</CardTitle>
        </CardHeader>
        <CardContent>
          {totalOrders30d === 0 ? (
            <p className="text-center text-sm text-muted-foreground py-4">No orders yet</p>
          ) : (
            <div className="space-y-2">
                ...
                .map(([status, count]) => (
                  <div key={status} className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-heading text-foreground capitalize">{status.replace('_', ' ')}</span>
                    </div>
                    <div className="flex items-center gap-2">
