            ...
            {view === 'category' && category && (
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full h-11 rounded-xl bg-[hsl(var(--c-text))] text-[hsl(var(--c-bg))] font-heading font-bold flex items-center justify-center gap-2 disabled:opacity-50"
                >
