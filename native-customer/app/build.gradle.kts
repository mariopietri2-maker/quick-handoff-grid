        ...
        create("release") {
            ...
            if (!envStore.isNullOrBlank() && !envAlias.isNullOrBlank()) {
                ...
                if (propsFile.exists()) {
                    ...
                    val path = p.getProperty("customerStoreFile") ?: p.getProperty("storeFile")
                    if (path != null) {
                        ...
                        keyAlias = p.getProperty("customerKeyAlias") ?: p.getProperty("keyAlias") ?: "fresh2go-customer"
