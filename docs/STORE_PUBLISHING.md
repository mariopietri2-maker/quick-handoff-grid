...
- `mobile-signing/fresh2go-customer-upload.jks`
- `mobile-signing/fresh2go-driver-upload.jks`
...
# → store-bundles/fresh2go-customer-release.aab
# → store-bundles/fresh2go-driver-release.aab
```
...
# → store-bundles/fresh2go-customer-ios-xcode.zip
# → store-bundles/fresh2go-driver-ios-xcode.zip
```
